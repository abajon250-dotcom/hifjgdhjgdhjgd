...
async def cmd_wd_amount(message: types.Message, state: FSMContext):
    ...
    if not amount or amount < 1.0:
        return await message.answer(f"❌ Минимум для вывода: 1 {DOLLAR}",
                                    parse_mode="HTML")
...
SPORT_TEXT = {
    ...
    ("боулинг", "1"):       ("bowling",    "p1"),
    ("боулинг", "3"):       ("bowling",    "p3"),
    ("боулинг", "4"):       ("bowling",    "p4"),
    ("боулинг", "5"):       ("bowling",    "p5"),
